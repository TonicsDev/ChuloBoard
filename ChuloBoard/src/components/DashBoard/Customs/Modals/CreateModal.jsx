...
export default function CreateModal({command, setCommand, addCommand, closeCreateModal, resetCommandState}) {
    ...
    return(
        <div className="modal">
            ...
            <motion.form className="modal-container" animate={control} onSubmit={addCommand} variants={variants} onAnimationComplete={anim => closeModal(anim)}>
                <div className="modal-header">
                    <h3 className="modal-title">Agregar comando</h3>
                    ...
                    <div className="modal-form">
                        <div className="input-group">
                            ...
                            <div className="input-container">
                                <input className="text-input" name="name" id="name" {...commandName} value={command.name}/>
                        ...
                        <div className="input-group">
                            ...
                            <div className="input-container">
                                <textarea name="message" id="message" ref={messageRef} onKeyUp={handleInput} maxLength={400} className="text-area" {...commandMessage} value={command.message}></textarea>
                                <span className="description-input">
